...
public class MockServerCommunicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng MOCKsrc1 = new LatLng(request.getSrc().latitude+0.0003,request.getSrc().longitude+0.0003);
        LatLng MOCKsrc2 = new LatLng(request.getSrc().latitude-0.0003,request.getSrc().longitude-0.0003);
